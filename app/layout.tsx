...
export const metadata: Metadata = {
  metadataBase: new URL("https://nakdev.ac.th"),
  title: {
    default: "โรงเรียนนักเดฟ — สถาบันการศึกษาเพื่อปัญญาและคุณธรรม",
    template: "%s · โรงเรียนนักเดฟ",
  },
  description:
    "โรงเรียนนักเดฟ สถาบันการศึกษาเอกชนตั้งแต่ระดับอนุบาลถึงมัธยมศึกษา มุ่งพัฒนาผู้เรียนอย่างสมดุลทั้งวิชาการ คุณธรรม และทักษะแห่งศตวรรษที่ 21",
  keywords: [
    "โรงเรียน",
    "การศึกษา",
    "อนุบาล",
